...
\cventry{2011--Actualidad}{Cursando Licenciatura en Análisis Sistemas}{Universidad Nacional de Salta}{Salta}{}{Actualmente me resta únicamente finalizar con el trabajo final exigido en la carrera para poder recibir la licenciatura}
...
\section{Experiencia}
\cventry{Octubre 2012 - actualidad}{Analista programador}{Secretaria General de la Gobernación}{Salta Capital}{Análisis y desarrollo de sistemas informáticos para el apoyo de la gestión de la Secretaria de Procedimientos de contrataciones y La Unidad Central de Contrataciones}{}
\cventry{Enero 2015 - actualidad}{Analista programador}{Clasapp.com}{Salta Capital}{Análisis y desarrollo de una aplicación web, esto incluye el desarrollo de un cliente web y un API RESTFull para acceder al sistema. El API debía servir tanto para el cliente web como para una aplicación Android}{}
...
\cvcomputer{Programación}{PHP, Javascript, Java medio avanzado, Python medio}{}{}
...
\cvitem{Personalidad}{Soy altamente adaptable a los diferentes entornos, siempre estoy predispuesto a mejorar y a aprender nuevas tecnologías, podría decirse que soy un autodidacta}
%\section{Intereses}
