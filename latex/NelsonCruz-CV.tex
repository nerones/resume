...
\section{Experiencia}
\cventry{Octubre 2012 - actualidad}{Analista programador}{Secretaria General de la Gobernación}{Salta Capital}{Análisis y desarrollo de sistemas informáticos para el apoyo de la gestión de distintos organismos del Gobierno Salteño y creacion de servicios web REST. Todos los sistemas se desarrollan con PHP y diferentes bases de datos. Aparte me dedico a mantener nuestra infraestructura de desarollo, incluyendo integración continua y deploy automatico de ambientes de testing/QA}{}
\cventry{Julio 2016 - 2018}{Programador}{Codedimension}{Salta Capital}{Desarrollo de frontends de sistemas varios para la promocion de Empresas o productos mediante diferentes framworks de php - codedimension.com.ar}{}
...
\cvcomputer{Programación}{PHP, Javascript, React, React Native, Vue, Java medio, Python medio}{}{}
\cvcomputer{Varios}{Integracion continua, Containers (Docker), Kubernetes, ELK stack}{}{}
\cvcomputer{Bases de Datos}{PostgreSQL, MySQL, SQLite, Elasticsearch}{}{}
\cvcomputer{Desarrollo web}{HTML5, CSS3, Service Workers}{}{}
